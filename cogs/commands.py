...
class Commands(commands.Cog):
    ...
    async def stock(self, ctx, args=""):
        ...
        if args == "market":
            ...
            await ctx.send(embed=em("Please use these commands for help on stocks!", "M.stock market, M.stock shares, M.stock prices, M.stock types, M.stock brokers"))
            await asyncio.sleep(1.5)
            await ctx.message.delete()
    ...
    async def drop_shipping(self, ctx, args=""):
        if args == "":
            ...
            return await ctx.send(embed=discord.Embed(title="Please use these commands for help on dropshipping!", description="M.dropshipping, M.dropshipping definition, M.dropshipping guide, M.dropshippinh profits, M.dropshipping products, M.dropshipping setup, M.dropshipping links"))
